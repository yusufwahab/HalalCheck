...
import { Calendar, Filter, Download, Eye, FileText, Shield, Clock, CheckCircle, Calculator, Award, Heart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-black text-gray-900">
                {historyData.filter(item => item.type === 'zakat_calculation').length}
              </span>
            </div>
            <h3 className="font-semibold text-gray-900">Zakat Calculations</h3>
